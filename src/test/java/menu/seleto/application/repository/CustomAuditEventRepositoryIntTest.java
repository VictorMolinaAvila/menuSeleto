package menu.seleto.application.repository;

import menu.seleto.application.MenuSeletoApp;
import menu.seleto.application.config.Constants;
import menu.seleto.application.config.audit.AuditEventConverter;
import menu.seleto.application.domain.PersistentAuditEvent;
...
import static menu.seleto.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
